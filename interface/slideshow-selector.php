<div class="bu-slideshow-selector">
	...
	<div class="bu-slideshow-selector-basic">
			...
			<p>
				<input type="checkbox" name="bu_slideshow_show_nav" id="bu_slideshow_show_nav" value="1"<?php echo esc_attr($args['show_nav']) ? ' checked="checked"' : ''; ?>/> <label for="bu_slideshow_show_nav"><?php esc_html_e('Display navigation', BU_SSHOW_LOCAL); ?></label>
			</p>
	...
	<p><?php esc_html_e('No slideshows found.', BU_SSHOW_LOCAL); ?> <a href="<?php echo esc_url(BU_Slideshow::$add_url); ?>" title="<?php esc_html_e('Create a new slideshow', BU_SSHOW_LOCAL); ?>"><?php esc_html_e('Add a Slideshow', BU_SSHOW_LOCAL); ?></a></p>

<div class="wrap">
	<h2><?php esc_html_e('Preview Slideshow', 'bu-slideshow'); ?></h2>
	...
	<?php } ?>
		<h4><?php esc_html_e('Note', 'bu-slideshow'); ?></h4>
		<p><?php esc_html_e('This preview uses the default settings. When you add this slideshow to a page, you will be able to customize the display settings.', 'bu-slideshow'); ?></p>

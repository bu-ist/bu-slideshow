<div class="wrap">
	...
	<h2><?php esc_html_e(sprintf("Edit Slideshow: %s", esc_html(stripslashes($this->name))), BU_SSHOW_LOCAL); ?></h2>
	...
	<div id="bu-slideshow-edit">
		<form id="bu-slideshow-editform" method="post" action="">
			...
			?>
			<p>
				<input type="submit" value="<?php esc_attr_e('Save Changes', BU_SSHOW_LOCAL); ?>" id="bu-slideshow-editform-submit" class="button-primary" />
			</p>
		</form>
	</div>
</div>
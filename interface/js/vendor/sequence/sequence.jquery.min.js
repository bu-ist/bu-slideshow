...
!a.settings.preloader||0===b&&0===c?e(window).on("load",function(){h();e(this).unbind("load")}):(d=function(b,c){var d=[];if(c)for(g=b;0<g;g--)d.push(e("body").find('img[src="'+a.settings.preloadTheseImages[g-1]+'"]')[0]);else for(var g=b;0<g;g--)a.sequence.children("li:nth-child("+a.settings.preloadTheseFrames[g-1]+")").find("img").each(function(){d.push(e(this)[0])});return d},b=d(b),c=d(c,!0),c=e(b.concat(c)),f(c,h))}m.prototype={initCustomKeyEvent:function(c){switch(c){case "next":this.next();
...
(g.delayUnpause?(g.delayUnpause=!1,g.unpause()):g.unpause(!1))});d.data("animationEnded",!1);c.on(g.transitionEnd,function(b){e(b.target).data("animationEnded",!0);var k=!0;d.each(function(){if(!1===e(this).data("animationEnded"))return k=!1});k&&(c.unbind(g.transitionEnd),h())})},setHashTag:function(){this.settings.hashTags&&(this.currentHashTag=this.nextFrame.attr(this.getHashTagFrom),this.frameHashIndex=e.inArray(this.currentHashTag,this.frameHashID),-1===this.frameHashIndex||!this.settings.hashChangesOnFirstFrame&&
...
a.charAt(0).toUpperCase()+a.slice(1),h=(a+" "+w.join(f+" ")+f).split(" ");if("string"===typeof c||"undefined"===typeof c)c=e(h,c);else a:{h=(a+" "+m.join(f+" ")+f).split(" "),a=h;for(var k in a)if(f=c[a[k]],f!==b){c=!1===d?a[k]:"function"===typeof f?f.on(d||c):f;break a}c=!1}return c}var f={},k=d.documentElement;c=d.createElement("modernizr");var a=c.style,w=["Webkit","Moz","O","ms"],m=["webkit","moz","o","ms"];c={};var x=[],r=x.slice,q,t={}.hasOwnProperty,p;"undefined"===typeof t||"undefined"===
typeof t.call?p=function(a,b){return b in a&&"undefined"===typeof a.constructor.prototype[b]}:p=function(a,b){return t.call(a,b)};Function.prototype.on||(Function.prototype.on=function(a){var b=self;if("function"!=typeof b)throw new TypeError;var c=r.call(arguments,1),d=function(){if(self instanceof d){var e=function(){};e.prototype=b.prototype;var e=new e,f=b.apply(e,c.concat(r.call(arguments)));return Object(f)===f?f:e}return b.apply(a,c.concat(r.call(arguments)))};return d});c.svg=function(){return!!d.createElementNS&&
